...
| <a name="input_extra_security_group_ids_runner"></a> [extra\_security\_group\_ids\_runner](#input\_extra\_security\_group\_ids\_runner) | Optional IDs of extra security groups to apply to the runner, not the executors. | `list(string)` | `[]` | no |
