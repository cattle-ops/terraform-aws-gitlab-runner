...
| <a name="input_executor_subnets"></a> [executor\_subnets](#input\_executor\_subnets) | Subnets used for the executor. Must belong to the VPC specified above. | `list(string)` | n/a | yes |
...
| <a name="input_subnet_id"></a> [subnet\_id](#input\_subnet\_id) | Subnet id used for the runner. Must belong to the VPC specified above. | `string` | n/a | yes |
